...
function goToNextPage() {
  window.location.href = "https://artlmt.github.io/flowerTwo/"; // Change this to your desired page
}

// Attach event listener to button
const replyBtn = document.getElementById("replay");
replyBtn.addEventListener("click", goToNextPage);
};
      ...
      Object.keys(data).forEach((customData) => {
        if (data[customData] !== "") {
          if (customData === "imagePath") {
            // Check if imagePath is an array
            if (Array.isArray(data[customData])) {
              const imageContainer = document.getElementById("imageContainer");
              imageContainer.innerHTML = ""; // Clear previous images

              data[customData].forEach((imgSrc) => {
